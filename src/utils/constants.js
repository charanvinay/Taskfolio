const constants = {
    ...
    DUMMY_AVATAR_URL: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fFBFUlNPTnxlbnwwfDF8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
}
...
export const THEME_VALUES = {
  ...
  CARD_BOXSHADOW: { light: "0px 1px 8px rgb(23 110 222 / 10%)", dark: "0 2px 20px rgba(0, 0, 0, 0.87)"},
